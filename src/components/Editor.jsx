      ...
      <div className="px-4 py-4 border-b border-ink-100 dark:border-ink-700 bg-ink-50/50 dark:bg-ink-800/40">
        ...
        <div className="space-y-3">
          ...
          <div className="flex gap-2">
            ...
            >
              {editingEntry ? <><Pencil size={14} />更新</> : <><Plus size={14} />追加</>}
            </button>
            {editingEntry && (
              <button
              ...
              return (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-sm text-ink-800 dark:text-ink-200 font-medium leading-snug mt-0.5">{entry.title}</p>
                    {entry.memo && (
                      <p className="text-xs text-ink-400 dark:text-ink-500 mt-0.5 leading-relaxed line-clamp-2">{entry.memo}</p>
                    )}
                  </div>
                  <div className="flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity flex-shrink-0">
                    ...
                    <button
                      onClick={() => {
                        if (confirm('この出来事を削除しますか？')) onDelete(entry.id)
                      }}
